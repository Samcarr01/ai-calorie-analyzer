...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-full text-sm font-semibold tracking-tight ring-offset-background transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default: "glass-button glass-button-primary",
        destructive:
          "glass-button bg-destructive/80 text-destructive-foreground hover:bg-destructive/90",
        outline:
          "border border-white/20 bg-white/5 text-white/80 backdrop-blur hover:bg-white/10 hover:text-white",
        secondary: "glass-button text-white/90 hover:bg-white/15",
        ghost:
          "bg-transparent text-white/70 hover:bg-white/10 hover:text-white",
        link: "bg-transparent text-white/80 underline-offset-4 hover:underline",
      },
      size: {
        default: "h-11 px-6",
        sm: "h-9 px-4 text-xs",
